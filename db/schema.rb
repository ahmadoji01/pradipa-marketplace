...
ActiveRecord::Schema.define(version: 2022_07_01_042610) do
  ...
  create_table "spree_collection_blogs", force: :cascade do |t|
    t.bigint "collection_id"
    t.bigint "blog_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["blog_id"], name: "index_spree_collection_blogs_on_blog_id"
    t.index ["collection_id"], name: "index_spree_collection_blogs_on_collection_id"
  end

  create_table "spree_collection_products", force: :cascade do |t|
    t.bigint "collection_id"
    t.bigint "product_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["collection_id"], name: "index_spree_collection_products_on_collection_id"
    t.index ["product_id"], name: "index_spree_collection_products_on_product_id"
  end
  ...
  add_foreign_key "spree_collection_blogs", "spree_blogs", column: "blog_id"
  add_foreign_key "spree_collection_blogs", "spree_collections", column: "collection_id"
  add_foreign_key "spree_collection_products", "spree_collections", column: "collection_id"
  add_foreign_key "spree_collection_products", "spree_products", column: "product_id"
  ...
  add_foreign_key "spree_withdrawals", "spree_users", column: "user_id"
end
