      ...
      class ShipmentsController < Spree::Api::BaseController
        ...
        def ship
          ...
          unless @shipment.shipped?
            ...
            @shipment.ship!
            add_withdrawal_balances(@shipment.line_items)
          end
          respond_with(@shipment, default_template: :show)
        end
        ...
        def add_withdrawal_balances(line_items)
            line_items.each do |line_item|
                ...
                wd_balance.total = 0.0
                if !line_item.product.user.nil?
                    wd_balance.user = line_item.product.user
                else
                    wd_balance.user_id = 1
                end
